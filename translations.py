translation_dict = {
    ...
    'Trilium requires JavaScript to be enabled.': 'Trilium erfordert JavaScript.',
    'Login': 'Anmelden',
    'Trilium login': 'Trilium Anmeldung',
    'Username': 'Benutzername',
    'Password': 'Passwort',
    'Remember me': 'Angemeldet bleiben',
    'Username and / or password are incorrect. Please try again.': 'Benutzername und/oder Passwort sind inkorrekt. Bitte versuchen Sie es erneut.',
    'Setup': 'Einrichtung',
    ...
    'This setup needs to be initiated from the desktop instance:': 'Diese Einrichtung muss von der Desktop-Instanz gestartet werden:',
    'please open your desktop instance of Trilium Notes': 'Bitte öffnen Sie Ihre Trilium Notes Desktop-Anwendung',
    ...
    'click on "Test sync" button': 'Klicken Sie auf die Schaltfläche "Sync testen"',
    ...
    'Please enter Trilium server address and credentials below. This will download the whole Trilium document from server and setup sync to it. Depending on the document size and your connection speed, this may take a while.': 'Bitte geben Sie die Trilium-Serveradresse und Anmeldedaten unten ein. Dies lädt das gesamte Trilium-Dokument vom Server herunter und richtet die Synchronisierung ein. Je nach Dokumentgröße und Verbindungsgeschwindigkeit kann dies einige Zeit dauern.',
    'Trilium server address': 'Trilium-Serveradresse',
    'Proxy server (optional)': 'Proxy-Server (optional)',
    'Note:': 'Hinweis:',
    ' If you leave proxy setting blank, system proxy will be used (applies to desktop/electron build only)': 'Wenn Sie die Proxy-Einstellung leer lassen, wird der Systemproxy verwendet (gilt nur für die Desktop-/Electron-Version)',
    'Sync in progress': 'Synchronisation läuft',
    "Sync has been correctly set up. It will take some time for the initial sync to finish. Once it's done, you'll be redirected to the login page.": 'Die Synchronisation wurde erfolgreich eingerichtet. Die initiale Synchronisation dauert eine Weile. Nach Abschluss werden Sie zur Anmeldeseite weitergeleitet.',
    'N/A': 'Nicht verfügbar',
    ...
    'I have a desktop instance already, and I want to set up sync with it': 'Ich habe bereits eine Desktop-Instanz und möchte die Synchronisation einrichten',
    'I have a server instance already, and I want to set up sync with it': 'Ich habe bereits eine Server-Instanz und möchte die Synchronisation einrichten',
    "You're almost done with the setup. The last thing is to choose username and password using which you'll login to the application.": 'Sie sind fast mit der Einrichtung fertig. Das letzte, was zu tun ist, besteht darin, einen Benutzernamen und ein Passwort auszuwählen, mit dem Sie sich anmelden werden.',
    ...
    'Add "${params.misspelledWord}" to dictionary': 'Fügen Sie "${params.misspelledWord}" zum Wörterbuch hinzu',
    'Cut': 'Ausschneiden',
    'Copy': 'Kopieren',
    ...
    'search for note by its name': 'Suche nach Notizen nach Namen',
    'Backend Log': 'Backend-Protokoll',
    'Refresh': 'Aktualisieren',
    'Edit branch prefix': 'Zweigpräfix bearbeiten',
    'Prefix': 'Präfix',
    'Save': 'Speichern',
    'Help on Tree prefix': 'Hilfe zum Baumpräfix',
    'Clone notes to ...': 'Notizen klonen nach...',
    'Notes to clone': 'Notizen zum Klonen',
    'Target parent note': 'Ziel-Elternnotiz',
    'Prefix (optional)': 'Präfix (optional)',
    'Clone to selected note ': 'Zu ausgewählter Notiz klonen',
    'Cloned note will be shown in note tree with given prefix': 'Der geklonte Hinweis wird im Notizbaum mit dem angegebenen Präfix angezeigt',
    'Confirmation': 'Bestätigung',
    'Cancel': 'Abbrechen',
    'OK': 'OK',
    'Delete notes preview': 'Notizenvorschau löschen',
    ...
    'HTML in ZIP archive - this is recommended since this preserves all the formatting.': 'HTML in ZIP-Archiv - dies wird empfohlen, da alle Formatierungen beibehalten werden.',
    'OPML v1.0 - plain text only': 'OPML v1.0 - nur Klartext',
    'OMPL v2.0 - allows also HTML': 'OMPL v2.0 - erlaubt auch HTML',
    'only this note without its descendants': 'nur diese Notiz ohne ihre Nachkommen',
    'HTML - this is recommended since this preserves all the formatting.': 'HTML - dies wird empfohlen, da alle Formatierungen beibehalten werden.',
    'Export': 'Exportieren',
    'this preserves most of the formatting.': 'dies erhält die meisten Formatierungen.',
    'outliner interchange format for text only. Formatting, images and files are not included.': 'Austauschformat für Text im Gliederungsstil. Formatierungen, Bilder und Dateien sind nicht enthalten.',
    'Help (full documentation is available ': 'Hilfe (vollständige Dokumentation ist verfügbar ',
    'online': 'online',
    'Note navigation': 'Notiznavigation',
    'UP': 'HOCH',
    'DOWN': 'RUNTER',
    ' - go up/down in the list of notes': ' - nach oben/unten in der Notizenliste',
    'LEFT': 'LINKS',
    'RIGHT': 'RECHTS',
    ' - collapse/expand node': ' - Knoten zusammenklappen/erweitern',
    ' - go back / forwards in the history': ' - Zurück/Vorwärts in der Historie',
    ' - show ': ' - anzeigen',
    '"Jump to" dialog': '"Zu" Dialog',
    ' - scroll to active note': ' - zu aktiver Notiz scrollen',
    'Backspace': 'Rücktaste',
    ' - jump to parent note': ' - zu Elternnotiz springen',
    ' - collapse whole note tree': ' - gesamten Notizbaum zusammenklappen',
    ' - collapse sub-tree': ' - Unterbaum zusammenklappen',
    'Tab shortcuts': 'Tab-Verknüpfungen',
    'CTRL+click': 'CTRL+Klick',
    ' (or middle mouse click) on note link opens note in a new tab': ' (oder mittlerer Mausklick) auf Notizlink öffnet die Notiz in einem neuen Tab',
    ...
    ' - create new note after the active note': ' - neue Notiz nach der aktiven Notiz erstellen',
    ' - create new sub-note into active note': ' - neue Unternotiz in die aktive Notiz erstellen',
    'Moving / cloning notes': 'Notizen verschieben / klonen',
    ' - move note up/down in the note list': ' - Notiz in der Notizenliste nach oben/unten verschieben',
    ' - move note up in the hierarchy': ' - Notiz in der Hierarchie nach oben verschieben',
    ' - multi-select note above/below': ' - Mehrfachauswahl der Notiz oben/unten',
    ...
    ' - paste note(s) as sub-note into active note (which is either move or clone depending on whether it was copied or cut into clipboard)': ' - Notiz(en) als Unternotiz in die aktive Notiz einfügen (die entweder verschoben oder geklont wird, je nachdem, ob sie in die Zwischenablage kopiert oder ausgeschnitten wurde)',
    ' - delete note / sub-tree': ' - Notiz / Unterbaum löschen',
    'Editing notes': 'Notizen bearbeiten',
    ' will switch back from editor to tree pane.': ' wechselt zurück vom Editor zum Baum-Panel.',
    'Ctrl+K': 'Strg+K',
    ' - create / edit external link': ' - Externen Link erstellen/bearbeiten',
    ' - create internal link': ' - Internen Link erstellen',
    ' - insert current date and time at caret position': ' - Aktuelles Datum und Uhrzeit an der Einfügemarke einfügen',
    ' - jump away to the tree pane and scroll to active note': ' - Zum Baum-Panel wechseln und zu aktiver Notiz scrollen',
    'Markdown-like autoformatting': 'Markdown-ähnliche Autoformatierung',
    ' etc. followed by space for headings': ' usw. gefolgt von einem Leerzeichen für Überschriften',
    ' or ': ' oder ',
    ...
    ' followed by space for block quote': ' gefolgt von einem Leerzeichen für einen Blockzitat',
    ...
    'Other': 'Sonstiges',
    ' - Zen mode - display only note editor, everything else is hidden': ' - Zen-Modus - Nur Notiz-Editor anzeigen, alles andere ist ausgeblendet',
    ' - focus on quick search input': ' - Fokus auf schnelle Sucheingabe',
    ' - in page search': ' - In-Seiten-Suche',
    'edit <a class="external" href="https://github.com/zadam/trilium/wiki/Tree concepts#prefix">prefix</a> of active note clone': 'Aktives Notiz-Klon-Präfix <a class="external" href="https://github.com/zadam/trilium/wiki/Tree concepts#prefix">bearbeiten</a>',
    'Import into note': 'In Notiz importieren',
    'Choose import file': 'Importdatei auswählen',
    'Content of the selected file(s) will be imported as child note(s) into ': 'Der Inhalt der ausgewählten Datei(en) wird als untergeordnete Notiz(en) importiert in',
    'Options:': 'Optionen:',
    'Options': 'Optionen',
    ...
    'Enable spellcheck': 'Aktiviere Rechtschreibprüfung',
    'Language code(s)': '',
    ...
    'Automatic backup': 'Automatische Sicherungen',
